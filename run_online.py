...
# reRank模型
rerank = reRankLLM("model/bge-reranker-large")
...
def chat(query, history):
    ...
    answer_0 = batch_output[0]  # 多路召回重排序后的结果
    ...
    # 对生成的答案进行一次润色
    new_answer = answer_polish(query, rerank_all_ans[0], answer_0)
    new_answer = llm([new_answer])
    answer_0 = new_answer[0]
